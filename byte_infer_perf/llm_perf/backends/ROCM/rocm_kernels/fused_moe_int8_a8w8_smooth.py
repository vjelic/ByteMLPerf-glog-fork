...
@triton.jit
def _triton_smooth_quantize_kernel(
    output_ptr,
    input_ptr,
    scale_ptr,
    vector_ptr,
    ...
    output_vals = (input_vals * smooth_per_token_scale + precison_mask).to(tl.int8)
...
def triton_smooth_quantize(out, input, scale, vector):
    ...
    if 0:
        ...
        smooth_quant = _triton_smooth_quantize_kernel
    smooth_quant[grid](*kwargs,**const_kwargs)
